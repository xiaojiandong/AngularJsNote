...
// 整个app的全部服务
var routerAppSer = angular.module('routerAppServices', []);
   ...
   var allStudents = {};
    allStudents.info = [ // 学生信息
       ...
       {'name':'王麻子','no':'2016540302','className':'高三(2)班','teacher':'刘老师','sex':'女','birthday':'1998.12.16','nativePlace':'山西-太原','index':'4',
        'tel' : '13854157474','totalScore':'340','classType':'2','avatar':'http://www.qqbody.com/uploads/allimg/201410/07-172542_747.jpg'},
...
routerAppSer.factory('SUBJFac' , function(){
    ...
    SUBJ.topBarInit = function(){
        ...
        }else if(SUBJ.hasUnitStr(winUrl,'score')){
