...
// 整个app的全部控制器
var routerAppCtrls = angular.module('routerAppCtrls', ['routerAppServices']);

// 顶层的父控制器
routerAppCtrls.controller('homeFooCtrl' , ['$rootScope','$scope','allStudentsInfo',
...
// 导航topbar
routerAppCtrls.controller('topbarCtrl' , ['$scope','SUBJFac',function($scope,SUBJFac){
    $scope.tobarItems = [
        {'sref' : 'index','text' : '首页'},
...
routerAppCtrls.controller('UserMngCtrl' ,['$rootScope','$scope','$state','allStudentsInfo',
...
// 全部用户分类控制器
routerAppCtrls.controller('allUsersCtrl',function( $scope , AllUserInfosFactory){
    $scope.names = AllUserInfosFactory.userInfo;
});

// 新增用户的控制器
routerAppCtrls.controller('addUserTypeCtrl' , ['$scope','$state','AllUserInfosFactory',
    function( $scope , $state ,AllUserInfosFactory){
    $scope.userName = '';
    $scope.userEmail = '';
    $scope.userPassword = '';
...
// 全部班级
routerAppCtrls.controller('classCtrl' , ['$rootScope','$scope','$state','allStudentsInfo','SUBJFac',
...
// 班级详情
routerAppCtrls.controller('classDetailCtrl' , ['$rootScope','$scope','$state','allStudentsInfo',
    function($rootScope,$scope,$state,allStudentsInfo){
...
// 编辑页面
routerAppCtrls.controller('detailUsersCtrl' , ['$rootScope','$scope','$state','allStudentsInfo','SUBJFac',
    function($rootScope , $scope , $state , allStudentsInfo,SUBJFac){
...
// 光荣榜
routerAppCtrls.controller('honorCtrl' , ['$scope','allStudentsInfo',function($scope,allStudentsInfo){
...
// 补考名单
routerAppCtrls.controller('blackCtrl' , ['$scope',function($scope){
...
// 成绩管理
routerAppCtrls.controller('scoreCtrl' , ['$rootScope','$scope','$state','allStudentsInfo','SUBJFac',
    function($rootScope,$scope,$state,allStudentsInfo,SUBJFac){
...
// 编辑
routerAppCtrls.controller('editCtrl' , ['$rootScope','$scope','$state','allStudentsInfo','SUBJFac',
    function($rootScope,$scope,$state,allStudentsInfo,SUBJFac){
...
// 学生注册
routerAppCtrls.controller('signupCtrl' , ['$rootScope','$scope','$state','allStudentsInfo','SUBJFac',
    function($rootScope,$scope,$state,allStudentsInfo,SUBJFac){
